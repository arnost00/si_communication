...
namespace si
{
   ...
   class channel_input: public channel_input_interface
   {
   public:
      ...
      void register_response_expectation(response_interface::pointer expectation
         ...
         , channel_input_interface::timeout_call_type timeout_call = channel_input_interface::timeout_call_type())
      {
         timer_pointer timeout_timer;
			...
			if(!(timeout.is_not_a_date_time()))
			{
				...
				timeout_timer->async_wait(boost::bind(&channel_input::timeout_expired, this, timeout_timer, timeout_call));
			}
